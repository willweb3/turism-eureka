...
const steps = [
  { number: 1, title: 'Basic Information', description: 'Tell us about your experience' },
  { number: 2, title: 'Contact & Social', description: 'How can travelers reach you?' },
  { number: 3, title: 'Pricing & Availability', description: 'Set your rates' },
...
export default function SubmitListingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA]">
      ...
      {/* Hero Section */}
      <section className="relative bg-[#02232F] pt-32 pb-20">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-lufga font-bold text-white mb-4">
              Submit Your Experience
            </h1>
            <p className="text-xl text-white/80 font-hanken">
              Share your unique Azorean experience with travelers from around the world
            </p>
          </div>
        </div>
      </section>
